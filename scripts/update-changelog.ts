...
const repo = `stencil/test-utils`
const corePackage = '@stencil/test-utils'
const ignoredPackages: string[] = ['vitest-environment-stencil']
const user = {
  name: 'John Jenkins',
  email: 'johnljenkins@hotmail.com',
}
